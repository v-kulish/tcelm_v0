    ...
    def run_stage(self) -> Dict[str, Any]:
        ...
        for rec in tqdm(all_input, desc="Normalizing & Cleaning", unit="doc"):
            ...
            rec_out = {
                ...
                "split_group_id": rec.get("split_group_id", rec["document_id"]),
                "source_repository": rec.get("source_repository", source_name),
                ...
                "source_record_id": rec.get("source_record_id", rec["document_id"]),
                ...
                "license_status": rec.get("license_status", rec.get("license", "missing")),
